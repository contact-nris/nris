jQuery(function ($) {
    ...
    da_share_elements.each(function(index){
        ...
        if ( da_share_elements.eq(index).hasClass('da-fb') ) {
            da_share_html += "<a class='btn btn-lg px-2 text-white' title='Facebook' style='background:#3b5998;' onclick='da_share.fb()'><i class='fa fa-facebook-square fa-fw fa-lg my-1'></i></a>";
        }
        if ( da_share_elements.eq(index).hasClass('da-vk') ) {
            da_share_html += "<a class='btn btn-lg px-2 text-white' title='VK' style='background:#0976b4' onclick='da_share.vk()'><i class='fa fa-lg fa-vk fa-fw my-1'></i></a>";
        }
        if ( da_share_elements.eq(index).hasClass('da-tw') ) {
            da_share_html += "<a class='btn btn-lg px-2 text-white' title='Twitter' style='background:#55acee' onclick='da_share.tw()'><i class='fa fa-twitter fa-fw fa-lg my-1'></i></a>";
        }
        if ( da_share_elements.eq(index).hasClass('da-ok') ) {
            da_share_html += "<a class='btn btn-lg px-2 text-white' title='OK' style='background:#ed812b' onclick='da_share.ok()'><i class='fa fa-odnoklassniki fa-fw fa-lg my-1'></i></a>";
        }
        if ( da_share_elements.eq(index).hasClass('da-pi') ) {
            da_share_html += "<a class='btn btn-lg px-2 text-white' title='Pinterest' style='background:#E60019' onclick='da_share.pi()'><i class='fa fa-fw fa-lg fa-pinterest my-1'></i></a>";
        }
