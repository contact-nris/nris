                ...
                <div class="col-lg-3 col-md-12 text-center text-lg-left">
                    <div class="breadcrumb-wrapper">
                        ...
                        <p><a href="{{ route('home') }}" class="text-white" style="font-size: 17px;">Home /</a>
                            <span
                                style="font-size:17px ;color:var(--main-color)">Temples</span>
                                 </p>
                    </div>
                </div>
...
<div class="section-padding">
	...
	?>
                                <div class="col-xs-12 col-sm-12 col-md-2 col-xl-2 p-0">
                                    <div class="featured-box position-relative">
                                        <figure>
                                            <a href="{{ route('front.temples.view', $list->slug) }}">
                                                <img  onerror="this.onerror=null;this.src='https://nris.com/stuff/images/default.png';"  class="img-fluid " src="{{ $list->image_url }}" alt=""></a>
                                        </figure>
                                        <?php
$hour = App\BusinessHour::where(['model' => 'f_temple', 'model_id' => $list->id])
		->get()
		->first();
	if ($hour) {
	...
	?>
                                        ...
                                        <div class="feature-content">
                                            <h4><a
                                                    href="{{ route('front.temples.view', $list->slug) }}">{{ $list->ShortTitle }}</a>
                                            </h4>
                                            <!-- <h4>
                                                    <div>
