            ...
            <div class="row align-items-center">
                <div class="col-lg-3 col-md-12 text-center text-lg-left">
                    <div class="breadcrumb-wrapper">
                        <h2 class="product-title">Groceries</h2>

                        <p><a href="{{ route('home') }}" class="text-white" style="font-size: 17px;">Home /</a>
                            <span
                                style="font-size:17px ;color:var(--main-color)">Groceries</span>
                                 </p>
                    </div>
                </div>
	...
	?>
                                <div class="col-xs-12 col-sm-12 col-md-2 col-xl-2 p-0">
                                    <div class="featured-box">
                                        <figure>
                                            <a href="{{ route('front.grocieries.view', $list->slug) }}"><img  onerror="this.onerror=null;this.src='https://nris.com/stuff/images/default.png';"
                                                    class="img-fluid " src="{{$list->image_url}}" alt="{{ $list->image_url   }}"></a>
                                        </figure>
                                        <?php
$hour = App\BusinessHour::where(['model' => 'f_grocery', 'model_id' => $list->id])
		->get()
		->first();
	if ($hour) {
	...
	?>
                                        ...
                                        <div class="feature-content">
                                            <h4><a
                                                    href="{{ route('front.grocieries.view', $list->slug) }}">{{ $list->ShortTitle }}</a>
                                            </h4>
