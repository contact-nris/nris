            ...
            <div class="row align-items-center">
                <div class="col-lg-3 col-md-12 text-center text-lg-left">
                    <div class="breadcrumb-wrapper">
                        <h2 class="product-title">Businesss</h2>

                        <p><a href="{{ route('home') }}" class="text-white" style="font-size: 17px;">Home /</a>
                            <span
                                style="font-size:17px ;color:var(--main-color)">Businesss</span>
                                 </p>
                    </div>
                </div>
	...
	?>
                                <div class="col-xs-12 col-sm-12 col-md-2 col-xl-2 p-0">
                                    <div class="featured-box">
                                        <figure>
                                            <a href="{{ route('front.business.view', $list->slug) }}"><img
                                                    class="img-fluid " src="{{ $list->image_url }}" alt=""></a>
                                        </figure>
                                        <?php
$hour = App\BusinessHour::where(['model' => 'f_business', 'model_id' => $list->id])
		->get()
		->first();
	if ($hour) {
	...
	?>
                                        ...
                                        <span class="bg-success position-absolute p-2 text-white"
                                            style="top:15px;right:16px;">24/7 open</span>
                                        ...
                                        <span data-time _open="<?=$current_time_open?>"
                                            ...
                                            style="top:15px;right:16px;"></span>
                                        @endif
                                        <div class="feature-content">
                                            <h4>
                                                <a
                                                    href="{{ route('front.business.view', $list->slug) }}">{{ $list->ShortTitle }}</a>
                                            </h4>
                                            <!-- <h4>
                                                <div>
