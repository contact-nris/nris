                ...
                <div class="col-lg-7 col-md-12 text-center text-lg-left">
                    <div class="breadcrumb-wrapper">
                        ...
                        <p><a href="{{ route('home') }}" class="text-white" style="font-size: 17px;">Home /</a>
                            <span
                                style="font-size:17px ;color:var(--main-color)">Baby Sitting</span>
                                 </p>
                    </div>
                </div>
                    ...
                    <form method="get" id="form_ajax" class="row" >
                        ...
                        <div class=" col-lg-3 col-md-3 col-xs-3">
                            <select name="category_type" class="form-control">
                                ...
                                <option <?=slug($t->name) == $category_type ? 'selected' : ''?>
                                    value="<?=$t->slug?>">
                                    <?=$t->name?>
                                </option>
                                <?php }?>
                        ...
                        <div class=" col-lg-3 col-md-3 col-xs-3">
                         ...
                         <div class="col-lg-3 col-md-3 col-xs-3 text-center">
                                <a href="{{ route('front.babysitting.list') }}""
                                    ...
                                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 pl-1 pr-1">
                                        <div class="featured-box">
                                            <figure class="update position-relative">
                                                <a
                                                    href="{{ route('front.babysitting.view', $list->slug) }}">
                                                    ...
                                                    <?php } else {?>
                                                        <img  onerror="this.onerror=null;this.src='https://nris.com/stuff/images/default.png';"  class="img-fluid"
                                                        src="{{ asset('upload/commen_img/baby-sitting.png') }}" alt="">
                                                    <?php }?>
                                                </a>
                                                @if($list->images)
                                            ...
                                            <div class="feature-content update">
                                                ...
                                                <h4><a
                                                        href="{{ route('front.babysitting.view', $list->slug) }}">{{ $list->ShortTitle }}</a>
                                                </h4>
...
<script>
    $('#form_ajax').on('submit', function (e) {
        var url = "{{ route('front.babysitting.list') }}";
