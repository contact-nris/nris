            ...
            <div class="row align-items-center">
                <div class="col-lg-7 col-md-12 text-center text-lg-left">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="current">{{ $other->title }}</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="product-info row">
            <div class="col-lg-8 col-md-12 col-xs-12">
                <div class="ads-details-wrapper">
                    <div id="other_ad" class="owl-carousel owl-theme owl-loaded owl-drag">
                        @if($other->images)
                        @foreach ($other->images as $key => $img)
                        <div class="item">
                        ...
                        <div class="item">
                            <div class="product-img">
                                <img  onerror="this.onerror=null;this.src='https://nris.com/stuff/images/default.png';"  class="img-fluid w-100" src="{{ asset('upload/commen_img/others.png') }}" alt="">
                            </div>
                        </div>
                        @endif
                    </div>
                    ...
                    <div class="ads-details-info">
                        ...
                        <div class="details-meta">
                            <span><a href="#"><i class="fa fa-calendar"></i>
                                    {{ date_with_month($other->created_at) }}</a></span>
                            </a></span>
                            <span><a href="#"><i class="fa fa-map-marker"></i> {{$other->city_id}}</a></span>
                            <span><a href="#"><i class="fa fa-eye"></i> {{$other->total_views}}</a></span>
                        </div>
                        <div class="mb-4 description">{!! $other->message !!}</div>
                        <h4 class="title-small mb-3">Specification:</h4>
                        <ul class="list-specification">
                            <div class="row pl-3">
                                <li><i class="fa fa-user"></i><strong> Contact Name </strong>
                                    {{$other->contact_name}}</li>
                                <li><i class="fa fa-phone"></i><strong> Contact Number </strong>
                                    {{$other->contact_number}}</li>
                                <li><i class="fa fa-crosshairs"></i><strong> Address </strong> {{$other->address}}
                                </li>
                                <li><i class="fa fa-globe"></i><strong> Url </strong><a href="{{$other->url}}" target="_blank"> {{$other->url}} </a></li>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card mt-3 comment-card">
                            ...
                            <div class="card-body">
                                <h2>Comment</h2>
                                <form action="{{ route('other.submit') }}" method="post" id="form">
                                    @csrf
                                    <input type="hidden" name="model_id" value="{{$other->id}}">
                            ...
                            <h2 class="card-title m-0">Comments</h2>
                                @include('layouts.comments',['route' => 'other.submit', 'model_id' =>
                                $other->id])
                            </div>
                        </div>
                    </div>
