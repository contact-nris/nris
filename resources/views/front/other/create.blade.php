        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <form method="post" action="{{ route('front.other.submit_ad', [$ad_type, $id]) }}" enctype="multipart/form-data" id="form">
                        ...
                        <div class="card-footer text-right">
                            ...
                            <a href="{{ route('other.index')}} " class="btn btn-primary">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
