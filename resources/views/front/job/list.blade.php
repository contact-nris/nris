...
<div class="page-header" style="background: url(assets/img/banner1.jpg); margin-top: 80px;">
        <div class="container m-t-124">
                ...
                <div class="col-lg-7 col-md-12 text-center text-lg-left">
                     ...
                     <div class="breadcrumb-wrapper">
                        ...
                        <p><a href="{{ route('home') }}" class="text-white" style="font-size: 17px;">Home /</a>
                            <span
                                style="font-size:17px ;color:var(--main-color)">Job</span>
                                 </p>
                    </div>
            ...
            <div class="col-sm-3 text-right">
                <a href="{{ route('front.job.create_ad','create_free_ad' ) }}" class="btn btn-success py-1 mb-2"
                    onclick="return CheckLogin(this);">Create Free Ad</a>
                <a href="{{ route('front.job.create_ad','create_premium_ad' ) }}" class="btn btn-warning py-1"
            ...
            <div class="col-sm-4 text-right">
                <a href="{{ route('front.job.create_ad','create_free_ad' ) }}" class="btn btn-success py-1"
                    onclick="return CheckLogin(this);">Create Free Ad</a>
                <a href="{{ route('front.job.create_ad','create_premium_ad' ) }}" class="btn btn-warning py-1"
                    onclick="return CheckLogin(this);">Create Premium Ad</a>
            </div>
                    ...
                    <form method="get" id="form_ajax" class="row" >
                        ...
                        <div class=" col-lg-3 col-md-3 col-xs-3">
                            <select name="category_type" class="form-control">
                                ...
                                <option <?=$t->slug == $category_type ? 'selected' : ''?>
                                    value="<?=$t->slug?>">
                                    <?=$t->name?>
                                </option>
                                <?php }?>
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 pl-1 pr-1">
                                    <div class="featured-box">
                                        <figure class="update position-relative">
                                            <a href="{{ route('job.view', $list->slug) }}">
                                                <?php if (!empty($list->images)) {?>
                                                <img  onerror="this.onerror=null;this.src='https://nris.com/stuff/images/default.png';"  class="img-fluid" src="{{ array_values($list->images)[0] }}"
                                                    alt="">
                                                <?php } else {?>
                                                <img  onerror="this.onerror=null;this.src='https://nris.com/stuff/images/default.png';"  class="img-fluid" src="{{ asset('upload/commen_img/jobs.png') }}"
                                                    alt="">
                                                <?php }?>
                                            </a>
                                            @if($list->images)
                                        ...
                                        <div class="feature-content update">
                                            <div class="product">
                                                <a href="javascript:void(0)">{{ $list->category_name_en }}</a>
                                            </div>
                                            <h4><a
                                                href="{{ route('job.view', $list->slug) }}">{{ $list->ShortTitle }}</a></h4>
