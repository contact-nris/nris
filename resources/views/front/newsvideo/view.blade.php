        ...
        <div class="container m-t-124">
            <div class="row align-items-center">
                <div class="col-lg-7 col-md-12 text-center text-lg-left">
                    ...
                    <h2 class="product-title">News Videos</h2>
                    <ol class="breadcrumb">
                        <li><a href="{{ route('home') }}">Home /</a></li>
                        <li class="current">News Videos</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-xs-12 mb-3">
                ...
                <iframe src="{{ $news_video->embaded_video_link }}" width="100%" height="350" frameborder="0"></iframe>
            </div>
        </div>
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                                        <div class="featured-box">
                                            <figure class="w-100">
                                                ...
                                                <a href="{{ $list->slug }}"><img  onerror="this.onerror=null;this.src='https://nris.com/stuff/images/default.png';"  class="img-fluid w-100" src="{{ $list->youtube_thumb }}" alt=""></a>
                                            </figure>
                                        </div>
                                    </div>
                                <?php }?>
