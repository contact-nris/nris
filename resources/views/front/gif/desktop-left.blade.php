 <div class="hideOnMobile  home-top-hide-ontab" style="width:10%"<?php if($sd == 0){
 //echo 'd-none';
 }?>>
                                    ...
                                    <div class="">
                                     ...
                                     $j=0;
                                        ...
                                        <div class="carousel-item <?php if($j==0) {echo 'active' ; } ?>">
                                               <a href="<?=$v22[1]?>"  title="<?=$v22['2'].'--w'. $width.'--h'. $height;?>" mode="desktop-left" target="_blank">
                                                <img  onerror="this.onerror=null;this.src='https://nris.com/stuff/images/default.png';" class="  gif-image-width"
