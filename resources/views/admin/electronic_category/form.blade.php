@extends('layouts.admin') @section('content') <div class="my-3 my-md-5">
  ...
  <div class="container">
    <div class="row">
      <div class="col-sm-12">
        <div class="card">
          <form action="{{ route('electronic_category.submit',[$category->id]) }}" method="post" id="form">
              ...
              <div class="row">
                ...
                <div class="col">
                  <div class="form-group">
                    ...
                    <input type="color" name="color" autofocus="" class="form-control w-8" value="{{ $category->color ? $category->color : '#35858B' }}">
                  </div>
                </div>
              </div>
            </div>
            <div class="card-footer">
              <div class="d-flex">
                <a href="{{ route('electronic_category.index') }}" class="btn btn-link">Cancel</a>
