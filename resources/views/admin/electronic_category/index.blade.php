...
<div class="my-3 my-md-5">
    <div class="container">
        <div class="page-header">
            <h1 class="page-title">Electronic Category List</h1>
            <div class="page-options">
                 <a href="{{ route('electronic_category.form') }}" class="btn btn-sm btn-outline-primary">Add New</a>
            </div>
        </div>
    </div>
                            ...
                            @foreach ($lists as $list)
                                <tr>
                                    ...
                                    <td class="text-right">
                                        ...
                                        <a class="btn btn-outline-primary btn-sm" href="{{ route('electronic_category.form',[$list->id]) }}"><i class="fe fe-edit"></i></a>
                                        <a class="btn btn-outline-danger confirm-link btn-sm" href="{{ route('electronic_category.delete',$list->id) }}"><i class="fe fe-trash"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
