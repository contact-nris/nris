<div class="modal fade" id="userMailModal" tabindex="-1" role="dialog" aria-labelledby="userMailModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content m-t-124">
            <div class="modal-header">
                <h5 class="modal-title" id="userMailModalLabel">Send Mail</h5>
	...
	<script type="text/javascript">
		...
		$("#userMailModal .send-mail").click(function(){
			$this = $(this);
			...
			$.ajax({
				url:'{{ route("user.index") }}?mailsubmit=true',
				type:'POST',
				dataType:'json',
				data:data,
				processData: false,
				...
				success:function(json){
					json_response(json,$("#userMailModal"));

					if(json['success_message']){
						$("#userMailModal").modal("hide")
					}
				},
			})
