...
<div class="my-3 my-md-5">
    <div class="container">
        <div class="page-header">
            <h1 class="page-title">Other Classifieds List</h1>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Other Classifieds Details</h3>
                    </div>
                    ...
                    <table class="table card-table table-sm table-hover">
                        ...
                        <tbody>
                            ...
                            <tr valign="middle">
                                ...
                                <td class="text-left">
                                    <div class="bword">{{ $list->states_name}}</div>
                                </td>
                                ...
                                <td class="text-right">
                                    <div>
                                        ...
                                        <button data-id='<?=$list->id?>' data-name="isPayed" class="btn toggle-btn btn-<?=$list->isPayed == 'Y' ? 'success' : 'secondary'?> btn-sm" type="button">
                                         ...
                                         <a class="btn btn-outline-warning btn-sm"target="_blank" href="{{ route('other.view',$list->id) }}"><i class="fe fe-eye"></i></a>

                                        <a class="btn btn-primary btn-sm" href="{{ route('other_classifieds.view',$list->id) }}"><i class="fe fe-eye"></i></a>
                                        <a class="btn btn-outline-danger confirm-link btn-sm" href="{{ route('other_classifieds.delete',$list->id) }}"><i class="fe fe-trash"></i></a>
...
<script type="text/javascript">
    $(".toggle-btn").click(function() {
        $this = $(this);
        $.ajax({
            url: '{{ route("other_classifieds.change_type") }}',
            type: 'POST',
            dataType: 'json',
            data: {
