...
<div class="my-3 my-md-5">
    <div class="container">
        <div class="page-header">
            <h1 class="page-title">NRI Card List</h1>
            <div class="page-options">
                 <a href="{{ route('nricard.form') }}" class="btn btn-sm btn-outline-primary">Add New</a>
            </div>
        </div>
    </div>
                        ...
                        <tbody>
                            @foreach ($lists as $list)
                                <tr>
                                    ...
                                    <td class="text-left">{{ $list->card_no }}</td>
                                    <td class="text-left">{{ $list->user_name }}</td>
                                    <td class="text-left">{{ $list->card_type == '1' ? 'Year' : 'Lifetime' }}</td>
                                    ...
                                    <td class="text-right">
                                        ...
                                        <a class="btn btn-outline-primary btn-sm" href="{{ route('nricard.form',[$list->id]) }}"><i class="fe fe-edit"></i></a>
                                        <a class="btn btn-outline-danger confirm-link btn-sm" href="{{ route('nricard.delete',$list->id) }}"><i class="fe fe-trash"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
