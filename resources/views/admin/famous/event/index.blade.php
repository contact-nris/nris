...
<div class="my-3 my-md-5">
    <div class="container">
        <div class="page-header">
            <h1 class="page-title">Famous Event List</h1>
            <div class="page-options">
                 <a href="{{ route('famous_event.form') }}" class="btn btn-sm btn-outline-primary">Add New</a>
            </div>
        </div>
    </div>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Famous Event Details</h3>
                    </div>
                            ...
                            @foreach ($lists as $list)
                                <tr>
                                    ...
                                    <td class="text-right">
                                        ...
                                        <a class="btn btn-outline-primary btn-sm" href="{{ route('famous_event.form',[$list->id]) }}"><i class="fe fe-edit"></i></a>
                                        <a class="btn btn-outline-danger confirm-link btn-sm" href="{{ route('famous_event.delete',$list->id) }}"><i class="fe fe-trash"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
