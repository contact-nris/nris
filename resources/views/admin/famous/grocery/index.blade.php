...
<div class="my-3 my-md-5">
    <div class="container">
        <div class="page-header">
            <h1 class="page-title">Famous Groceries List</h1>
            <div class="page-options">
                 <a href="{{ route('famous_grocery.form') }}" class="btn btn-sm btn-outline-primary">Add New</a>
            </div>
        </div>
    </div>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Famous Groceries Details</h3>
                    </div>
                        ...
                        <tbody>
                            @foreach ($lists as $list)
                                <tr>
                                    ...
                                    <td class="text-left">{{ $list->city_name }}</td>
...
// print_r($_SESSION[]);
?>
                                        <a class="btn btn-outline-warning btn-sm"target="_blank" href ="https://{{get_state_name_by_code( $list->state_code) }}.nris.com/grocieries-view/{{$list->slug}}" href1="{{ route('front.grocieries.view',$list->slug) }}"><i class="fe fe-eye"></i></a>

                                         <!--<a class="btn btn-outline-warning btn-sm"target="_blank" href="{{ route('front.grocieries.view',$list->id) }}"><i class="fe fe-eye"></i></a>-->

                                        <a class="btn btn-outline-primary btn-sm" href="{{ route('famous_grocery.form',[$list->id]) }}"><i class="fe fe-edit"></i></a>
                                        <a class="btn btn-outline-danger confirm-link btn-sm" href="{{ route('famous_grocery.delete',$list->id) }}"><i class="fe fe-trash"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
