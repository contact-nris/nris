...
<div class="my-3 my-md-5">
    <div class="container">
        <div class="page-header">
            <h1 class="page-title">Auto Colors List</h1>
            <div class="page-options">
                 <a href="{{ route('autocolor.form') }}" class="btn btn-sm btn-outline-primary">Add New</a>
            </div>
        </div>
    </div>
                        ...
                        <tbody>
                            @foreach ($lists as $list)
                                <tr valign="middle">
                                    ...
                                    <td class="text-left"><div style="border: solid 1px #ddd;border-radius: 2px;width: 40px;height: 30px;display: inline-block;background:{{ $list->code }}"></div></td>

                                    <td class="text-right">
                                         <!--<a class="btn btn-outline-warning btn-sm"target="_blank" href="{{ route('front.grocieries.view',$list->id) }}"><i class="fe fe-eye"></i></a>-->

                                        <a class="btn btn-outline-primary btn-sm" href="{{ route('autocolor.form',[$list->id]) }}"><i class="fe fe-edit"></i></a>
                                        <a class="btn btn-outline-danger confirm-link btn-sm" href="{{ route('autocolor.delete',$list->id) }}"><i class="fe fe-trash"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
