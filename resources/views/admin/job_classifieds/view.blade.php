...
<div class="my-3 my-md-5">
    <div class="container">
        <div class="page-header">
            <h1 class="page-title">Jobs Classifieds View</h1>
            ...
            <div class="col-sm-4">
                <div class="card">
                    <?php if (isset($electronics->images[0])) {?>
                        <div class="card-img-top img-responsive img-responsive-16by9" style="background-image: url('{{ $electronics->images[0] }}')"></div>
                    <?php }?>
                    ...
                    <table class="table table-detail table-bordered table-sm ">
                        <thead>
                            ...
                            <tr>
                                ...
                                <td><a class="call_link" href="tel:<?php echo $electronics->contact_number; ?>"><?php echo ucwords($electronics->contact_number); ?></a></td>
                            </tr>
                            <tr>
                                <th>Email</th>
                            ...
                            <tr>
                                <th>Display Email?</th>
                                <td><?php if ($electronics->show_email == 'Yes') {echo "Yes";} else {echo "No";}?> </td>
                            </tr>
                            <tr>
                                <th>City</th>
