@extends('layouts.admin') @section('content') <div class="my-3 my-md-5">
  <div class="container">
    <div class="page-header">
      <h1 class="page-title">Room Mate Category</h1>
    </div>
  </div>
  <div class="container">
    <div class="row">
      <div class="col-sm-12">
        <div class="card">
          <form action="{{ route('room_mate_category.submit',[$category->id]) }}" method="post" id="form">
            ...
            <div class="card-footer">
              <div class="d-flex">
                <a href="{{ route('room_mate_category.index') }}" class="btn btn-link">Cancel</a>
