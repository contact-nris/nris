...
<div class="my-3 my-md-5">
    <div class="container">
        <div class="page-header">
            <h1 class="page-title">Education & Teaching Category List</h1>
            <div class="page-options">
                <a href="{{ route('education_teaching_category.form') }}" class="btn btn-sm btn-outline-primary">Add
                    New</a>
            </div>
        </div>
    </div>
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    <a class="btn btn-outline-primary btn-sm"
                                        href="{{ route('education_teaching_category.form',[$list->id]) }}"><i
                                            class="fe fe-edit"></i></a>
                                    <a class="btn btn-outline-danger confirm-link btn-sm"
                                        href="{{ route('education_teaching_category.delete',$list->id) }}"><i
