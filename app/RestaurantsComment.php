...
class RestaurantsComment extends Model {
	public $table = 'restaurants_comment';
	protected $casts = [];
	protected $appends = [
		'image_url',
	];
	...
	public function child() {
		return $this->hasMany('App\RestaurantsComment', 'reply_id', 'id')
			->selectRaw('restaurants_comment.*, users.profile_photo, users.first_name, users.last_name')
